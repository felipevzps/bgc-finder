...
#########################################
# Author: [Felipe Vaz Peres](https://github.com/felipevzps)
# File: extractContigsFromWhokaryote.py
# Source: https://github.com/felipevzps/seabed-symphony/blob/main/playground/8_prokaryote_contigs/extractContigsFromWhokaryote.py
#########################################
